      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0">
          <div className="text-center md:text-left">
            <p className="text-xl font-bold text-primary-600">진호쌤의 실험교실</p>
            <p className="mt-2 text-sm text-gray-500">배움을 더 즐겁게, 수학을 더 가깝게.</p>
          </div>
        ...
        <div className="mt-12 border-t pt-8 text-center text-sm text-gray-400">
          <p>© {currentYear} 진호쌤의 실험교실. All rights reserved.</p>
